...
export default function Header() {
  ...
  return (
    <>
      <div className="flex items-center justify-between w-full p-2.5 bg-gradient-to-br from-emerald-800 to-green-800 fixed top-0 left-0 z-50 rounded-b-2xl shadow-lg">
        ...
        <div className="flex gap-5 items-center">
          <Link href="/" passHref>
            <div className="h-9 m-0 cursor-pointer">
              <img alt="Magic Number Games Logo" src="/magicnumbergames.svg" className="h-full" />
            </div>
          </Link>
        </div>
